    ...
    <div className='relative h-0 z-40'>
      <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center'>
        <motion.div
          ...
          <Landmark
            size={40}
            className='text-slate-800 dark:text-white select-none'
          />
          <span className='text-[8px] font-black uppercase tracking-[0.2em] mt-1 text-slate-500 dark:text-slate-400'>
            The Bank
          </span>
        </motion.div>
      </div>
