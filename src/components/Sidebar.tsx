...
import { History, Settings, Sliders, Landmark } from 'lucide-react';
  ...
  return (
    <>
      <div 
        ...
        onClick={onClose}
      />
      <nav className={`fixed inset-y-0 left-0 w-72 bg-white dark:bg-[#0f151c] z-[120] shadow-2xl transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-8 pt-16 h-full flex flex-col">
          <div className="flex items-center space-x-4 mb-12">
            ...
            <div>
              <h1 className="font-black text-2xl dark:text-white leading-tight">Banker</h1>
              <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">Monopoly Companion</p>
            </div>
          </div>
